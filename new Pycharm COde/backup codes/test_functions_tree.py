...
from SMD_Solver_Tree import DRO_SMD_Tree
...
def n_num_test_tree(n_list_nt, J_nt, L_nt, opt_low_nt, opt_up_nt, obj_tol_nt, C_K_nt, alpha_tol_nt,
    ...
    for n_num in n_list_nt:
        ...
        for rep_idx in tqdm(range(repeats_nt)):
            ...
            stat_SMD = DRO_SMD_Tree(x_0_nt, p_0_nt, emp_dist_value, K_nt, K_grad_nt, delta_nt, rho_nt, \
                               opt_low_nt, opt_up_nt, obj_tol_nt, RHS_nt, ss_type_nt, C_K_nt,
            ...
            stat_SMD = DRO_SMD_tree(x_0_nt, p_0_nt, emp_dist_value, K_nt, K_grad_nt, delta_nt, rho_nt, alpha_tol_nt,\
                               opt_low_nt, opt_up_nt, obj_tol_nt, RHS_nt, ss_type_nt, C_K_nt,
                               T_cap_nt, print_option=print_opt, K_test_flag=0, min_flag=min_flag)
            stat_alg.append(stat_SMD)
