...
from test_functions_tree import n_num_test_tree
...
alpha_tol_nt = 1e-10
dual_gap_freq_nt = 1000
var_scale_nt = 0.01  # Variance of our data
...
stat_list_nt_diminish = n_num_test_tree(n_list_nt, J_nt, L_nt, opt_low_nt, opt_up_nt, obj_tol_nt, C_K_nt, \
