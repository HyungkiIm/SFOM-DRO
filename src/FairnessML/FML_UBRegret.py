...
def R_dim_SMD_x(G_x,D_x,T): #return R_x and c_x
    """
    Return the R_x and c_x for SMD with dimishing stepsize
    """
...
def R_dim_SMD_p(G_p_max, D_p, T): #return R_p and c_p, Review this bound again
    """
    Return the R_p and c_p for SMD with dimishing stepsize
    """
...
def R_dim_SMD(d, n, G, M, delta, rho, obj_tol, C_g, C_K, C_s):
    ...
    """
    Find the number of iterations T, R_x, R_p, c_x, c_p for Stochastic Mirror Descent (SMD) with diminishing stepsize
    """
...
def R_dim_FMD(d, n, G, M, rho, obj_tol):
    ...
    """
    Find the number of iterations T, R_x, R_p, c_x, c_p for Full Mirror Descent (FMD) with diminishing stepsize
    """
